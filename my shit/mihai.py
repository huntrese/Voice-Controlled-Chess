...
match (right[2]):
 case "knight":
  print("n" + right[1][-2:]) if "to" in right[1] else print("nx" + right[1][-2:])
 case "queen":
  print("q" + right[1][-2:]) if "to" in right[1] else print("qx" + right[1][-2:])
 case "rook":
  print("r" + right[1][-2:]) if "to" in right[1] else print("rx" + right[1][-2:])
 case "king":
  print("k" + right[1][-2:]) if "to" in right[1] else print("kx" + right[1][-2:])
 case "bishop":
  print("b" + right[1][-2:]) if "to" in right[1] else print("bx" + right[1][-2:])
 case "pawn":
  print("p" + right[1][-2:]) if "to" in right[1] else print("px" + right[1][-2:])
